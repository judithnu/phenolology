...
simplot <- function(datalist, label) {
  ...
  p3 <- ggpubr::ggarrange(p1, p2, nrow=2, labels = label)
  print(p3)
}
...
parplot <- function(label, pardf, cutpoints, beta, h) {
  ...
  ggpubr::ggarrange(cutplot, betaplot, h1plot, h2plot, nrow=1, ncol=4, labels=plot_title)
}
...
gammafits <- parLapply(cl, parlist, function(x) {fit_gamma_model(simdatlist <- datlist, pars=x)})
