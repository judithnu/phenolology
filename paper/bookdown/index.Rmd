...
While gene flow is high, local adaptation is extensive in lodgepole pine [@Liepe2015, @mahonya] and there is evidence for spatially varying levels of gene flow tied to climate [@Yeaman2006].
...
Flowering phenology determines which populations can exchange genes, but work on predicting the timing of pollen shed and cone receptivity is scarce and coarse.
Determining the amount of forcing required for a phenological event to occur is rarely done for species that lack economic importance because collecting the data is time and labour intensive. 
When it is done, estimates are often location and population specific. 
Flowering phenology examples are uncommon for conifers. Simple heat accumulation thresholds (*Pinus taeda*) [@Boyer1978] or elevation (*Pinus flexilis*) [@Schuster1989] were used previously to explain or predict pollen shed in limited spacial and temporal contexts. Risto Sarvas's work in Scots pine (*Pinus sylvestris*) is a rare exception. Through extensive field and laboratory experiments
