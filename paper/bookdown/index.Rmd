...
The timing and duration of pollen shed and cone receptivity in lodgepole pine affects its fecundity, gene flow, and adaptation. Being able to predict flowering phenology will help us understand patterns of local adaptation, gene flow, and population structure as well as the effects of climate change on forests. With 15 years of data from 7 lodgepole pine provenances grown at 7 sites, we built a multilevel Bayesian model of lodgepole pine flowering phenology and used it to determine the amount of forcing required to begin and end the period of pollen shed and cone receptivity. With this method, any record of mean daily temperature can be used to estimate lodgepole pine flowering phenology. Cones become receptive slightly after pollen starts shedding and receptivity ends slightly before shed ends. Provenance did not have a strong effect on flowering time. In simple climate change scenarios with increases of 2 and 5 degrees, the amount of phenological overlap between sites did not significantly increase or decrease with increasing temperatures because earlier flowering dates keeps the rate of temperature accumulation within the flowering period relatively consistent.
...
Changes in pollination phenology can affect fecundity, gene flow, and even range size in a species and have knock-on effects on dependent species [@Inouye2008; @Chuine2001b].

Conifers are a big part of the enormous northern hemisphere forests and many have wide ranges with lots of local adaptation. Common garden experiments and genetic work reveal extensive local adaptation in many forest tree species, especially boreal and temperate conifers (reviewed in @Alberto2013). A locally adapted population only grows optimally in a subset of the range and may tolerate a more limited climatic range than the species as a whole. In northern hemisphere conifers, local adaptation often reflects strong trade-offs between avoidance of cold damage and competitive height growth (summarized in @aitken2008). 

Coniferous forest trees are wind pollinated with pollination possible over very large distances. Pine and spruce pollen have been recorded travelling 3000km [@Campbell1999]. While most trees are pollinated by local pollen donors, long distance pollen dispersal makes up a significant amount of effective pollen flow. Seed orchards typically struggle to reproductively isolate their stands, despite placing them at a distance from natural stands (*e.g.* @Slavov2005, @SkLai2010, @stoehrEvaluationMatingDynamics2002). @robledo-arnuncioWindPollinationMesoscale2011 found that at least 4.4% of effective pollen flow into an isolated *Pinus sylvestris* stand was from a population 100km away. At the expanding range edge of both *Pinus ponderosa* [@lesser2013] and *Picea sitchensis* [@elleouet2019], long distance pollen-mediated gene flow was critical for persistence of colonizing populations

In conifers, pollen is shed from male strobili and must arrive at receptive female strobili for successful pollination.
(Gymnosperm strobili are not flowers, but this paper will follow the common practice of referring to the processes of pollen shed and cone receptivity as "flowering.") 
Differences in flowering timing lead to assortative mating within populations and differential gene flow among populations, with important consequences for genetic diversity, fitness, and rate of evolution [@fox2003, @Ellstrand2014]. 
Shifts in flowering timing in conifers could lead to gene flow changes that hinder or promote adaptation under climate change [@rousi2019, @Whittet2017b], decrease fitness[@gleiser2018]], reduce additive genetic variance in flowering time [@Franks2015], affect forest regeneration through seed production declines, and even damage reforestation and conservation efforts [@Wadgymar2015a].

Lodgepole pine is a good representative of these issues as an economically and ecologically important tree species facing multiple threats from climate change [@Schneider2010; @Sambaraju2012; @Hamann2006]. 
Lodgepole pine has a very large geographical distribution (across 33$^\circ$ latitude and 31$^\circ$ longitude) encompassing a wide range of climates and soils (Fig. \@ref(fig:rangemap)). 
Understanding flowering timing could lead to a better understanding of adaptive capacity and maintenance of local adaptation in lodgepole pine 
While gene flow is high, local adaptation is extensive in lodgepole pine [@Liepe2015, @mahonya] with strong differences in performance between different provenances [@Wang2010]. Local adaptation in lodgepole pine can be observed even at relatively small spatial scales when topographic variability is high: in a reciprocal transplant experiment, growth declines were observed when moving high elevation populations just 100m in elevation [@rehfeldt1983] and there is evidence for spatially varying levels of gene flow tied to climate [@Yeaman2006].
 
Synchronization in flowering phenology will play a strong role in determining which populations can exchange genes in lodgepole pine because outcrossing is nearly obligate, pollen dispersal is extensive, and seed dispersal is relatively limited [@Ennos1994]. 
However, work on predicting the timing of pollen shed and cone receptivity is scarce and coarse.
Estimates are often location and population specific, considering only the day of year an event occurred and not the amount of forcing required to trigger an event. 
Collecting flowering phenology data in mature forest trees is challenging because of their height and the long period of observation required.
However, simple heat accumulation thresholds (*Pinus taeda*) [@Boyer1978] or elevation (*Pinus flexilis*) [@Schuster1989] were used previously to explain or predict pollen shed in limited spacial and temporal contexts. Risto Sarvas's work in Scots pine (*Pinus sylvestris*) is a rare exception. Through extensive field and laboratory experiments, they determined the rate of forcing at temperatures between x and y etc.

SARVAS FLOWERING PHENOLOGY
...
PARAGRAPH ON POPULATION VARIATION
...
No. 1) How strong are the genetic vs. environmental effects on pollination phenology? NOT, talk about APCs.
...
No. 2) How does faster spring warm-up like we expect under climate change affect within population mating success and frequency of outcrossing? 
...
for 2020-12-17 model run. Calculated with `diagnostics.R`

|id     |  bulk_ess| tail_ess|
|:------|---------:|--------:|
|fbsims |  696.4815| 1417.250|
|fesims |  741.2277| 1383.805|
|mbsims |  940.9436| 1601.639|
|mesims | 1095.3261| 2089.605|
