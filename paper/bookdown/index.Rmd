...
```{r surveys, fig.height=12, echo=FALSE, fig.cap='(ref:surveys)'}
...
For each site, climateNA temperatures $T$ were regressed on mean monthly PNWNAmet temperatures $t$ with `lm` in R's `stats` package (Tab. \@ref(tab:climatecorrection-pars)).
