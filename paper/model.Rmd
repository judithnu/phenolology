...
fit_draft <- ulam(
    ...
    data=mdf, sample=FALSE, declare_all_data = FALSE) #change data depending on male or female model

write(stancode(fit_draft), file="male.stan")
```
...
fitm <- stan("male.stan", 
               chains=1, cores=1, warmup = 11, iter=22, 
               data=mdf)
