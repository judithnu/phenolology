...
<!-- I then calculated the point at which at least 50% of trees of a given sex in a given year at a given site from a given provenance had begun flowering ($f50_{obs}$).   -->
...
[Do a reverse graph forcing vs proportion of data points that match model predictions]
