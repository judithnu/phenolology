...
[Map of Sites with nearest gridpoints]
...
### Actual methods
I modeled the derived phenological states with a Bayesian multilevel ordered logistic model fit in Stan with the no-u-turn sampler [@standevelopmentteamRStanInterfaceStan2018].
