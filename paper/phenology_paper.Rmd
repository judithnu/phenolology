...
To check the usefulness of the model, the data was compared to model predictions. I simulated a phenological state from all model configurations for each phenological observation in the dataset.
