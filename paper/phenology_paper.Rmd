...
![Map of seed orchard locations. Seed orchard locations are in red. Weather data gridpoints are in blue. Boxed area in map on left is shown in greater detail on the right. \label{Sites} ](/home/sus/Documents/research_phd/maps/SiteMaps/sitemapwithPCIC.png)
...
![Proportion of states correctly predicted by the model for each phenophase. \label{ppc_prop}](~/Documents/research_phd/Lab_Notebook/images/2019-10-14_proportionstatescorrpredicted.png)
...
![Proportion of states correctly predicted by the model for each phenophase and site. \label{ppc_site}](~/Documents/research_phd/Lab_Notebook/images/2019-10-16_propstatescorrpredsite.png)

When the model incorrectly retrodicts a phenophase, it usually predicts an adjacent phenophase.

![Count of states predicted at each observed phenophase. \label{ppc_counts}](~/Documents/research_phd/Lab_Notebook/images/2019-10-16_modelpredsateachobsphenophase.png)

The model is very likely to correctly predict phase 1 and 3 at very high and low amounts of accumulated forcing.

![Proportion of observations correctly predicted as forcing accumulates \label{ppc_forcing}](~/Documents/research_phd/Lab_Notebook/images/2019-10-16_proppredforcingunits.png)
