...
### Actual methods
I modeled the derived phenological states with a multilevel ordered logistic model fit in Stan [@standevelopmentteamRStanInterfaceStan2018].

$$\begin{array}{ll}
S_i&\sim \mathrm{Categorical}(p) &\text{probability of data} \\
